...
**DELETE behavior:** hard-deletes the row (no soft-archive — this is a personal note list, not purchase-linked) after explicitly deleting its unsent reminders. **Response:** `{ deleted: true }`.
