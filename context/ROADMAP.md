...
- Supabase project setup — migrations 003, 004, 005, 006, 008, 011, 012, 013 and the private `wishlist-images` bucket with owner-folder storage policies must be applied/created before wishlist reorder, sharing, auto-creation, manual image uploads, profile avatar/phone editing, catalog-wishlist duplicate prevention, invite signup backfill, and shared-wishlist private/archived differentiation fully work (009 and 010 are applied)
